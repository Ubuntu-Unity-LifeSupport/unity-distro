...
Nothing in flight. Last (2026-09-26): known issue #1 reproduced and fixed -
unity-settings-daemon `0ubuntu7+unity4` in aptly (`research/cursor-after-login/`,
DECISIONS 2026-09-26). Before: xorg-server `2:21.1.22-1ubuntu1.3+unity1`
with the `xorg-watch` timer (`research/xorg-versioning/`). Open: #3 itself
(not reproduced).
